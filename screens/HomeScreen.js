...
export default function HomeScreen() {
      ...
      if (updateError) {
        ...
        if (deleteError) {
          Toast.show({
            type: "error",
            text1:
              deleteError.code === "23503" ? "Cannot Delete Account" : "Error",
            text2:
              deleteError.code === "23503"
                ? "You have existing orders. Please contact support."
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "white", flex: 1 }}>
      ...
      >
        <Ionicons name="person-circle-outline" size={26} color="#4a90e2" />
        <Text
          style={{
            fontSize: 18,
            fontWeight: "600",
      ...
      <View style={{ paddingHorizontal: 16, marginTop: 12 }}>
        ...
        >
          ...
          <TextInput
            ...
            style={{ flex: 1, marginLeft: 10, fontSize: 16, color: "#1E3A8A" }}
            value={searchText}
            onChangeText={setSearchText}
          />
          {searchText !== "" && (
            <TouchableOpacity onPress={() => setSearchText("")}>
              <Ionicons name="close-circle" size={20} color="#60a5fa" />
            </TouchableOpacity>
          )}
        </View>
      </View>
      ...
      >
        ...
        >
          {({ pressed }) => (
            <>
              <Ionicons
                name={pressed ? "home" : "home-outline"}
                size={26}
                color="#1F2937"
              />
              <Text
        ...
        >
          {({ pressed }) => (
            <>
              <Ionicons
                name={pressed ? "person" : "person-outline"}
                size={26}
                color="#6B7280"
              />
              <Text
          ...
          >
            ...
            {!isGuest && (
              <>
                ...
                >
                  <Ionicons name="star-outline" size={22} color="#1F2937" />
