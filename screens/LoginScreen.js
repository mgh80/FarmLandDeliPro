...
const LoginScreen = () => {
  ...
  // ======================================================
  // 1️⃣ GUARDAR O ACTUALIZAR EL USUARIO EN SUPABASE
  // ======================================================
  ...
  // ======================================================
  // 2️⃣ LOGIN CON GOOGLE (Expo Go + Dev Build + EAS)
  // ======================================================
  const handleGoogleLogin = async () => {
    try {
      setIsLoading(true);

      // 🔥 Redirect universal para Expo Go
  ...
  // ======================================================
  // 3️⃣ LOGIN NORMAL (Email y contraseña)
  // ======================================================
  ...
  // ======================================================
  // 4️⃣ VERIFICAR SESIÓN AUTOMÁTICAMENTE
  // ======================================================
  useEffect(() => {
